var firebaseConfig = { apiKey: "AIzaSyC0yDH0-16JN2AvcvLes5R8ZXWhSoaFfq8",
 ...
 function getData(){
   firebase.database().ref("/").on('value',function(snapshot){ childKey = childSnapshot.
    document.getElementById("output").innerHTML = "";snapshot.forEach(function(snapshot){ childKey = childSnapshot.key;
      Room_names = childKey;
